...
function merge(imp) {
	// тут до пизды кастыль на самом деле, но работает, этот цикл проходится по каждому элементу
	// и в каждой итерации каждый элемент вбирает в себя интервалы других элементов
